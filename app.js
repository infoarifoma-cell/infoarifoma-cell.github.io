...
async function _ensayosGenerarPDF() {
  ...
  for (const sem of sems) {
    ...
    const COORDS = {
      'granulometria|0/4':    {x:310, y:640},
      'granulometria|4/12':   {x:335, y:640},
      'granulometria|12/20':  {x:360, y:640},
      'granulometria|20/40':  {x:385, y:640},
      ...
      'ind_lajas|4/12':       {x:335, y:580},
      'ind_lajas|12/20':      {x:360, y:580},
      'ind_lajas|20/40':      {x:385, y:580},
